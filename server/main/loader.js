...
const Loader = function (logger, configMain) {
  ...
  this.handleConfigs = function () {
    ...
    if (fs.existsSync(normalizedPath + "procyon.js")) {
      config = require(normalizedPath + "procyon.js");
      ...
      throw new Error(
        "Unable to find procyon.js file. Read the installation/setup instructions"
      );
    }
    return config;
  };
